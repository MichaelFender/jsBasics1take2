...
//CODE HERE
let clone = {description: 'This command Clones a repository into a newly created directory', code: 'git clone <repositoryURL>'}
...
let commit = {description: 'The git commit command saves a snapshot of your repo at a specific point in time.', code: 'git commit -m "commit message" '}
